                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <!-- Action -->
                        <p><strong>Kindly follow the below important steps before accessing website:</strong><br /> 
                          1. Please <a href="https://blog.isharankumar.com/sign-in">Sign-In to your account</a>.<br />
                          2. Navigate to profile on the top right.<br />
                          3. Click on <strong>Verify</strong>.
                        </p>
                        <p>
                ...
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Dear {{name}},</h1>
                        <h2>Your account with email id {{email}} created on {{date_join}} has not been verified yet. And scheduled for permanent delection. Please verify your account within the next 24 hours to avoid deletion.</h2>
                        <!-- Action -->
                        <p><strong>Kindly follow the below steps:</strong><br /> 
                          1. Please <a href="https://blog.isharankumar.com/sign-in">Sign-In to your account</a> immediately.<br />
                          2. Navigate to profile on the top right.<br />
                          3. Click on <strong>Verify</strong>.
                        </p>
                        <p><a href="mailto:email@isharankumar.com">Contact me</a> if you have questions.</p>
...
export const ACCOUNT_DELETED_MAIL =`
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                ...
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Dear {{name}},</h1>
                        <h2>Your unverified account with email id {{email}}, created on {{date_join}}, has been permanently deleted from our system as it was not verified within 15 days of joining date.</h2>
                        <!-- Action -->
